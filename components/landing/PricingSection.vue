    ...
    <div class="container">
      <div class="text-center mb-16">
        ...
        <h2 class="text-3xl md:text-4xl text-center font-bold mb-4">
          Choose your best option for growing up your business
        </h2>
      </div>
      <table class="shadow-md rounded max-w-5xl m-auto">
        <thead
          class="sticky block top-0"
          scope="col"
        >
        ...
        <tbody>
          ...
          <tr class="flex text-left">
            <td
              class="p-4 bg-gray-100 dark:bg-gray-900 border border-t-0 border-gray-300 min-w-full border-b-0 u-slab text-orange-500"
            >
              Support
            </td>
          </tr>
          ...
          <tr class="flex text-left text-sm flex-wrap sm:no-wrap">
            ...
            <td class="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-t-0">
              <svg
                ...
                class="feather feather-check text-primary m-auto"
              >
                <title id="catTitle">
        ...
        <tfoot>
          <tr class="flex text-left text-sm">
            ...
            >
              <a
                href=""
                class="mt-auto block text-white bg-primary text-xs py-2 text-center rounded font-normal rounded-bt"
                title=""
              >Request a demo</a>
            </td>
          </tr>
