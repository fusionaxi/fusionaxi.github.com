...
<template>
  <div class="page">
    ...
    <section class="w-full px-8 text-gray-700 bg-white">
      ...
      >
        <div class="relative flex flex-col md:flex-row">
          ...
          >
            <span
              ...
              >FUSION AXI<span class="text-orange-600">.</span></span
            >
          </a>
          <nav
            class="hidden flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200"
          >
            <a
              href="#_"
        ...
        <div class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
          ...
          <a
            href="#"
            class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-orange-600 border border-transparent rounded-md shadow-sm hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-600"
          >
            Sign up
          </a>
        </div>
          ...
          <div class="w-full md:w-1/2 md:px-3">
            ...
            >
              ...
              <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                <a
                  href="#_"
                  class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-orange-600 rounded-md sm:mb-0 hover:bg-orange-700 sm:w-auto"
                >
                  Try It Free
                  <svg
    ...
    <!-- Section 5 -->
    <section
      class="hidden items-center justify-center py-20 bg-white min-w-screen"
    >
    ...
    <section class="bg-white">
      ...
      >
        <nav class="hidden flex-wrap justify-center -mx-5 -my-2">
          <div class="px-5 py-2">
            <a
              href="#"
        ...
        <div class="hidden justify-center mt-8 space-x-6">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
          © {{ new Date().getFullYear() }} Fusion Axi (Soft Axi Indonesia). All rights reserved.
        </p>
      </div>
    </section>
  </div>
